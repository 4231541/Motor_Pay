...
return [
     ...
     */
    'disk_name' => env('MEDIA_DISK', 'local'), // Override in .env: local | s3 | r2
     ...
     */
    'max_file_size' => 1024 * 1024 * 20, // 20MB — suitable for high-resolution car images
     ...
     */
    'queue_conversions_by_default' => env('QUEUE_CONVERSIONS_BY_DEFAULT', true), // Set to false in local .env for synchronous conversion during dev
